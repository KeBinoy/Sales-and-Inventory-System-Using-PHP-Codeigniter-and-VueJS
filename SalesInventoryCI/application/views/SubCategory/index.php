...
<div class="container-fluid" id="appSubCategory">
	...
	<div class="card mb-12">
		...
		<div class="row">
			<div class="col-sm-7">
				<label><a class="btn btn-success btnRight" href="#" @click="addModal= true">New Sub Category</a></label>
				<!-- <button class="btn btn-default" @click="addModal= true">Add</button> -->
			</div>
			<div class="col-sm-5">
				<input placeholder="Seach Sub/Category Name" type="search" class="form-control" v-model="search.text" @keyup="searchSubCategory" name="search">
		...
		<div class="table-responsive">
			<table class="table table-bordered table-hover" width="95%" cellspacing="0">
				...
				<tbody>
					...
					<tr v-for="sub_category in subCategories" class="table-default">
						<td>{{sub_category.sub_category_id}}</td>
						<td>{{sub_category.sub_category_name}}</td>
						<td>{{sub_category.sub_category_description}}</td>
						<td>{{sub_category.category_name}}</td>
						<td align="center">
							<i class="fas fa-fw fa-eye iconClick" aria-hidden="true" @click="readModal = true; selectSubCategory(sub_category)" ></i> | 
							<i class="fa fa-edit iconClick" aria-hidden="true" @click="editModal = true; selectSubCategory(sub_category)"></i>
						</td>
					</tr>
					<tr v-if="emptyResult">
...
<script src="<?php echo base_url(); ?>assets/js/app/appSubCategoryJS.js"></script>
